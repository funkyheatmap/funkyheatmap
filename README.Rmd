...
You need to provide some information on how each column should be rendered, fox example:
...
* Check out the vignette [`vignette("mtcars", "funkyheatmap")`](https://funkyheatmap.github.io/funkyheatmap/articles/mtcars.html)
