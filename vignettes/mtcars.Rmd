...
column_info <- tribble( # tribble_start
  ...
  "id",    "method_info",  "",                                          "text",       NA,          list(hjust = 0, width = 10),
