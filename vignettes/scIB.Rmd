...
column_info <- tribble(# tribble_start
                              ~id,                   ~id_color,                   ~name,    ~geom,         ~group,   ~palette,  ~width,  ~legend,  ~hjust,  ~overlay,
                             "id",                          NA,                  "Rank",   "text",       "Method",         NA,       1,    FALSE,       0,     FALSE,
                         "method",                          NA,                "Method",   "text",       "Method",         NA,       5,    FALSE,       0,     FALSE,
                     "output_img",                          NA,                "Output",  "image",       "Method",         NA,       1,    FALSE,     0.5,     FALSE,
                       "features",                          NA,              "Features",   "text",       "Method",         NA,       2,    FALSE,     0.5,     FALSE,
                        "scaling",                          NA,               "Scaling",   "text",       "Method",         NA,       1,     TRUE,     0.5,     FALSE,
               "overall_pancreas",             "rank_pancreas",              "Pancreas",    "bar",          "RNA",    "blues",     1.5,     TRUE,      NA,     FALSE,
                 "label_pancreas",                          NA,                      NA,   "text",          "RNA",         NA,      NA,    FALSE,     0.1,      TRUE,
             "overall_lung_atlas",           "rank_lung_atlas",                  "Lung",    "bar",          "RNA",    "blues",     1.5,     TRUE,      NA,     FALSE,
               "label_lung_atlas",                          NA,                      NA,   "text",          "RNA",         NA,      NA,    FALSE,     0.1,      TRUE,
        "overall_immune_cell_hum",      "rank_immune_cell_hum",        "Immune (human)",    "bar",          "RNA",    "blues",     1.5,     TRUE,      NA,     FALSE,
          "label_immune_cell_hum",                          NA,                      NA,   "text",          "RNA",         NA,      NA,    FALSE,     0.1,      TRUE,
    "overall_immune_cell_hum_mou",  "rank_immune_cell_hum_mou",  "Immune (human/mouse)",    "bar",          "RNA",    "blues",     1.5,     TRUE,      NA,     FALSE,
      "label_immune_cell_hum_mou",                          NA,                      NA,   "text",          "RNA",         NA,      NA,    FALSE,     0.1,      TRUE,
            "overall_mouse_brain",          "rank_mouse_brain",           "Mouse brain",    "bar",          "RNA",    "blues",     1.5,     TRUE,      NA,     FALSE,
              "label_mouse_brain",                          NA,                      NA,   "text",          "RNA",         NA,      NA,    FALSE,     0.1,      TRUE,
        "overall_simulations_1_1",      "rank_simulations_1_1",                 "Sim 1",    "bar",  "Simulations",   "greens",     1.5,     TRUE,      NA,     FALSE,
          "label_simulations_1_1",                          NA,                      NA,   "text",  "Simulations",         NA,      NA,    FALSE,     0.1,      TRUE,
          "overall_simulations_2",        "rank_simulations_2",                 "Sim 2",    "bar",  "Simulations",   "greens",     1.5,     TRUE,      NA,     FALSE,
            "label_simulations_2",                          NA,                      NA,   "text",  "Simulations",         NA,      NA,    FALSE,     0.1,      TRUE,
                  "package_score",              "package_rank",               "Package",    "bar",    "Usability",  "oranges",     1.5,     TRUE,      NA,     FALSE,
                  "package_label",                          NA,                      NA,   "text",    "Usability",         NA,      NA,    FALSE,     0.1,      TRUE,
                    "paper_score",                "paper_rank",                 "Paper",    "bar",    "Usability",  "oranges",     1.5,     TRUE,      NA,     FALSE,
                    "paper_label",                          NA,                      NA,   "text",    "Usability",         NA,      NA,    FALSE,     0.1,      TRUE,
                     "time_score",                 "time_rank",                  "Time",    "bar",  "Scalability",    "greys",     1.5,     TRUE,      NA,     FALSE,
                     "time_label",                          NA,                      NA,   "text",  "Scalability",         NA,      NA,    FALSE,     0.1,      TRUE,
                   "memory_score",               "memory_rank",                "Memory",    "bar",  "Scalability",    "greys",     1.5,     TRUE,      NA,     FALSE,
                   "memory_label",                          NA,                      NA,   "text",  "Scalability",         NA,      NA,    FALSE,     0.1,      TRUE
) # tribble_end
