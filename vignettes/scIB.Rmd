...
The [single-cell integration benchmarking (scIB)][scib] project was an effort to evaluate and compare the performance of methods for integrating single-cell RNA and ATAC sequencing datasets [@scib_Luecken2021].
