...
ggsave("test3.pdf", g, device = "pdf")

g_path <- funky_heatmap(
  data = data_path,
  column_info = column_info_data_path,
  column_groups = column_groups,
  row_info = row_info,
  row_groups = row_groups,
  palettes = palettes,
...
ggsave("test_data_path.pdf", g, device = "pdf")
